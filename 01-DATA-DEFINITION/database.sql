...
-- this will login to both your mysql session and your database
mysql -u root -p robinsnest

-- this will log you out of your mysql terminal session
\q
...
-- view information inside the table
SELECT * FROM people;
